...
This document contains Laravel implementation patterns specific to the Artist-Tree project. Always consult `.gemini/guidelines/laravel-boost.md` for comprehensive Laravel framework guidelines.
...
For comprehensive Laravel framework guidelines, see `.gemini/guidelines/laravel-boost.md`.
