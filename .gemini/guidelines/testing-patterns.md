...
This document contains testing patterns specific to Artist-Tree. Always consult `.gemini/guidelines/laravel-boost.md` for comprehensive Pest framework guidelines.
...
For comprehensive Pest framework guidelines and browser testing, see `.gemini/guidelines/laravel-boost.md`.
