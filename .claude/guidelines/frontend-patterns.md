...
This document contains Vue/Inertia/Tailwind patterns specific to Artist-Tree. Always consult `.claude/guidelines/laravel-boost.md` for comprehensive framework guidelines.
...
For comprehensive Vue/Inertia/Tailwind framework guidelines, see `.claude/guidelines/laravel-boost.md`.
