...
import type { Lineup, LineupStats, ScheduleSlot, TierType } from './types';
...
export const lineups: Lineup[] = [
    {
        ...
        artistStatuses: {
            1: {
                status: 'confirmed',
                fee: 500000,
                notes: 'Headline act Saturday',
                contactEmail: 'booking@kendricklamar.com',
            },
            2: {
                status: 'contract_signed',
                fee: 450000,
                notes: 'Deposit received',
                contactEmail: 'mgmt@billieeilish.com',
            },
            13: {
                status: 'negotiating',
                fee: 600000,
            ...
            14: {
                status: 'idea',
                fee: null,
                notes: 'Would be amazing Friday headliner',
                contactEmail: '',
            },
            15: {
                status: 'outreach',
            ...
            16: {
                ...
                fee: 420000,
                notes: 'DocuSign sent 12/21, waiting',
                contactEmail: 'tde@sza.com',
            },
            17: {
                status: 'idea',
                fee: null,
                notes: 'Latin representation - checking availability',
                contactEmail: '',
            },
            9: {
                status: 'contract_sent',
                fee: 300000,
                notes: 'Sent via DocuSign 12/20',
                contactEmail: 'tyler@golfwang.com',
            },
            10: {
                status: 'negotiating',
                fee: null,
            ...
            4: {
                ...
                contactEmail: 'mgmt@tameimpala.com',
            },
            7: {
                status: 'outreach',
                fee: null,
                notes: 'Initial email sent 12/18',
                contactEmail: 'bea@dirtyhit.com',
            },
            8: {
                status: 'confirmed',
                fee: 100000,
                notes: '',
                contactEmail: 'disclosure@island.com',
            },
            5: {
                status: 'idea',
                fee: null,
                notes: 'Would be great for Sunday afternoon',
                contactEmail: '',
            },
            6: {
                status: 'negotiating',
            ...
            11: {
                ...
                contactEmail: 'kieran@textrecords.com',
            },
            12: {
                status: 'declined',
                fee: null,
                notes: 'Not available during festival dates',
                contactEmail: 'sam@ninjatune.com',
            },
        },
    },
    {
...
export function getLineupStats(lineup: Lineup): LineupStats {
    ...
    const avgScore =
        artists.length > 0
            ? Math.round(
                  artists.reduce((sum, a) => sum + a.score, 0) / artists.length,
              )
            : 0;
...
export function getLineupSchedule(
    lineupId: number,
