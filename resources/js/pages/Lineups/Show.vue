...
const {
    ...
    left: searchLeft,
    width: searchWidth,
} = useElementBounding(searchContainerRef);
                ...
                >
                    <div
                        ...
                        :class="[
                            ...
                            isStuck
                                ? 'fixed z-50 flex h-16 items-center border-b-2 border-primary/10 bg-background/95 px-4 shadow-md backdrop-blur-md md:px-6'
                                : 'relative w-full',
                        ]"
                        :style="
                            isStuck
