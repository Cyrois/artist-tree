    ...
    <div class="flex flex-col space-y-6 max-w-2xl">
        <Card>
            ...
            <div class="grid gap-2">
                <Label for="name">{{ trans('settings.profile_name_label') }}</Label>
                <Input
                    id="name"
            ...
            <div class="grid gap-2">
                <Label for="email">{{ trans('settings.profile_email_label') }}</Label>
                <Input
                    id="email"
                    type="email"
                    class="mt-1 block w-full"
            ...
            <div v-if="mustVerifyEmail && !user.email_verified_at">
                <p class="-mt-4 text-sm text-muted-foreground">
                    ...
                    >
                        {{ trans('settings.profile_resend_verification') }}
                    </Link>
                </p>
